...
W praktyce na Dżerbie oznacza to:

1. **tunezyjski arabski** – najlepszy do podstawowego kontaktu i grzeczności;
2. **francuski** – najbardziej użyteczny język pomocniczy poza ścisłą strefą hotelową;
3. **angielski** – zwykle wystarcza w hotelach, przy wycieczkach i części usług turystycznych, ale nie należy zakładać, że wszędzie;
4. **tamazight/berberyjski** – element lokalnego dziedzictwa, ale nie język, którego warto uczyć grupę jako podstawowego środka komunikacji.

Źródła:

- [Tunisian National Tourist Office – informacje ogólne o językach](https://www.discovertunisia.com/en/infos-pratiques/general-information)
...
## Jak czytać zapis wymowy

Przy zwrotach podajemy, gdy jest to użyteczne:

1. **oryginalny zapis** – po arabsku albo francusku;
2. **zapis łaciński** – szczególnie przy tunezyjskim arabskim;
3. **wymowę po polsku** – uproszczoną tak, aby osoba polskojęzyczna mogła możliwie łatwo wypowiedzieć zwrot;
4. **znaczenie po polsku**.

Polska wymowa jest **przybliżeniem praktycznym**, a nie naukową transkrypcją fonetyczną. Zarówno tunezyjski arabski, jak i francuski mają dźwięki, których polszczyzna nie odwzorowuje dokładnie.

W zapisie tunezyjskiego arabskiego spotyka się w internecie cyfry, np. `3`, `7` i `9`. Oznaczają one arabskie głoski, dla których zabrakło prostych odpowiedników alfabetu łacińskiego. W naszej ściądze cyfrowy zapis nie jest podstawową pomocą do wymowy, ponieważ jest mało intuicyjny po polsku i może być niewygodny przy korzystaniu z czytnika ekranu.

W polskiej wymowie:

- **sz** odpowiada mniej więcej tunezyjskiemu `ch` / arabskiemu `ش`;
- **ch** czytamy po polsku, nie jak angielskie „cz”;
- **k** może zastępować głębsze arabskie `q`, jeżeli celem jest po prostu zrozumiała wymowa turystyczna;
- przy arabskim `ع`, `ح` i `غ` podajemy tylko przybliżenie, ponieważ nie mają dokładnych polskich odpowiedników;
- francuskie samogłoski nosowe zapisujemy przybliżeniami typu **ą**; nie należy oczekiwać idealnego francuskiego brzmienia.

Źródła pomocnicze dotyczące zapisu tunezyjskiego arabskiego:

- [Derja.Ninja – zasady transliteracji tunezyjskiego arabskiego](https://derja.ninja/about/)
- [Asla – podstawowe słowa w tunezyjskim arabskim](https://getasla.com/en/learn-tunisian-arabic)

## Najważniejsza zasada

Nie trzeba mówić po arabsku, żeby poradzić sobie na Dżerbie. Warto jednak znać kilka krótkich zwrotów, bo są bardzo przydatne jako otwarcie rozmowy i sygnał szacunku.

Najbardziej praktyczny zestaw to:

- powitanie po tunezyjsku;
- podziękowanie;
- przeproszenie;
- pytanie o cenę;
- „tak”, „nie” i „nie rozumiem”;
- francuskie zwroty awaryjne dotyczące kierunku, ceny, pomocy i płatności.

## Tunezyjski arabski – minimum

Tunezyjski arabski nie ma jednego powszechnie stosowanego sposobu zapisu alfabetem łacińskim. Dlatego można spotkać różne wersje tego samego słowa, np. `qaddech`, `qaddesh`, `kaddech` albo zapis cyfrowy `9addech`.
...
- [Derja.Ninja – aslema](https://derja.ninja/e/3ce83119-3894-46c1-ad2b-e4dbf7e7473a)
- [Derja.Ninja – beslema](https://derja.ninja/e/8c635017-13bf-4e25-a56c-ea8be7362db5)
- [Ithaca Bound Languages – 3aychek](https://www.ithacaboundlanguages.com/thank-you-thanks-in-tunisian-arabic/)
- [Derja.Ninja – użycie samahni](https://derja.ninja/e/f7235808-b38e-4bb5-9611-f2534009943c)
...
- [Tunisie.co – praktyczne zwroty w tunezyjskim dialekcie](https://tunisie.co/article/594/decouverte/dialecte/dialecte-235714)
- [Le Karmous – słownik tunezyjsko-francuski, hasło qaddèch](https://www.lablebi.org/ref/dico-karmous.pdf)
- [Derja.Ninja – zasady zapisu głosek tunezyjskich](https://derja.ninja/about/)

## Francuski – praktyczny zestaw ratunkowy

Francuski jest bardzo użyteczny w Tunezji i może być bardziej przydatny niż angielski poza hotelami.

Polska wymowa poniżej jest celowo uproszczona. Nie zastępuje nagrania native speakera, ale powinna pozwolić wypowiedzieć zwrot w sposób rozpoznawalny.
...
W hotelach, na lotnisku, w części restauracji turystycznych i przy zorganizowanych wycieczkach angielski jest zwykle użyteczny.

Nie warto jednak zakładać, że osoba prowadząca mały sklep, taksówkarz albo mieszkaniec starszego pokolenia będzie mówił po angielsku. Dlatego francuski zestaw ratunkowy jest ważniejszy niż rozbudowany zestaw angielskich fraz.
...
- alfabetu arabskiego jako warunku korzystania ze ściągi;
- rozbudowanej gramatyki;
- długich zdań po tunezyjsku;
