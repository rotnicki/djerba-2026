...
Podczas wyjazdu przypadającego na przełom sierpnia i września ochrona przed słońcem nadal jest istotna. Dane klimatyczne dla Dżerby wskazują, że w sierpniu i we wrześniu średni maksymalny indeks UV wynosi około **7**, czyli mieści się w kategorii wysokiej. To wartość klimatyczna, a nie prognoza na konkretny dzień, dlatego bieżący UVI należy sprawdzać w prognozie pogody podczas pobytu.

WHO zaleca stosowanie ochrony przeciwsłonecznej już od UVI 3. Piasek i woda mogą dodatkowo odbijać promieniowanie UV, dlatego sam parasol plażowy lub przebywanie przy wodzie nie zapewniają pełnej ochrony.

Źródła:

- [WHO – indeks UV i zalecane działania ochronne](https://www.who.int/news-room/questions-and-answers/item/radiation-the-ultraviolet-%28uv%29-index)
- [CDC Yellow Book 2026 – ekspozycja podróżnych na słońce i promieniowanie UV](https://www.cdc.gov/yellow-book/hcp/environmental-hazards-risks/sun-exposure-in-travelers.html)
- [Weather Atlas – średni indeks UV i warunki klimatyczne na Dżerbie we wrześniu](https://www.weather-atlas.com/en/tunisia/djerba-weather-september)

### Najważniejsza zasada ochrony

Najlepsza ochrona nie polega wyłącznie na kremie. WHO i CDC zalecają łączenie kilku metod:

- ograniczanie bezpośredniej ekspozycji na słońce w środku dnia;
- korzystanie z cienia;
- osłanianie skóry odzieżą;
- odpowiednie nakrycie głowy;
- okulary przeciwsłoneczne chroniące przed UVA i UVB;
- krem przeciwsłoneczny na odkryte części skóry.

WHO podkreśla, że krem przeciwsłoneczny nie powinien służyć do wydłużania czasu przebywania na słońcu.

Źródła:

- [WHO – ochrona przed promieniowaniem UV i rakiem skóry](https://www.who.int/news-room/questions-and-answers/item/radiation-protecting-against-skin-cancer)
- [CDC Yellow Book 2026 – zasady bezpiecznej ekspozycji na słońce w podróży](https://www.cdc.gov/yellow-book/hcp/environmental-hazards-risks/sun-exposure-in-travelers.html)

### Nakrycie głowy — kapelusz lepszy niż zwykła czapka z daszkiem

CDC zaleca kapelusz z rondem biegnącym dookoła głowy o szerokości około **7,5 cm lub większej**, tak aby osłaniał twarz, uszy i kark. CDC wprost zaznacza, że standardowa czapka typu baseballowego nie zapewnia dostatecznej ochrony uszu i karku.

Praktycznym wyborem na Dżerbę będzie więc lekki i przewiewny kapelusz z szerokim rondem. Alternatywą może być nakrycie głowy z dodatkową osłoną karku. Dodatkową zaletą jest oznaczenie tkaniny UPF 30 lub wyższe; UPF 50 zapewnia bardzo wysoką ochronę przed przenikaniem promieniowania UV przez materiał.

Źródło: [CDC Yellow Book 2026 – kapelusze i odzież chroniąca przed promieniowaniem UV](https://www.cdc.gov/yellow-book/hcp/environmental-hazards-risks/sun-exposure-in-travelers.html)

### Krem przeciwsłoneczny — jaki filtr wybrać

WHO i CDC zalecają preparat o szerokim zakresie ochrony, czyli chroniący zarówno przed UVA, jak i UVB, z filtrem co najmniej **SPF 30**. Na wyjazd do Tunezji na przełomie sierpnia i września rozsądnym, bardziej zachowawczym wyborem jest **SPF 50 lub 50+**, szczególnie przy plażowaniu, pływaniu i dłuższym przebywaniu na zewnątrz.

Na opakowaniu warto szukać jednocześnie:

- SPF 50 lub 50+;
- ochrony UVA i UVB albo oznaczenia „broad spectrum”;
- wodoodporności lub określenia „water resistant”, szczególnie do kąpieli i na plażę.

Preparat należy nakładać obficie na odkrytą skórę przed wyjściem na słońce. GIS zaleca aplikację około 15–20 minut przed ekspozycją oraz ponawianie jej co około 2 godziny, a także po kąpieli, pływaniu, intensywnym poceniu się i wycieraniu ręcznikiem.

CDC podaje orientacyjnie około 30 ml preparatu na pełną aplikację na odkryte powierzchnie ciała przeciętnego dorosłego. W praktyce oznacza to, że mała butelka 200 ml może nie wystarczyć jednej osobie na tydzień regularnego plażowania, szczególnie gdy preparat jest ponawiany po kąpieli.

Szczególnie łatwo pominąć uszy, kark, nos, skórę głowy przy przedziałku lub przerzedzonych włosach, grzbiety dłoni oraz stóp.

Źródła:

- [GIS – jak prawidłowo stosować kosmetyki chroniące przed słońcem](https://www.gov.pl/web/gis/bezpieczne-lato--jak-chronic-sie-przed-sloncem-i-cieszyc-wakacjami)
- [WHO – wybór i prawidłowe stosowanie preparatów przeciwsłonecznych](https://www.who.int/news-room/questions-and-answers/item/radiation-protecting-against-skin-cancer)
- [CDC Yellow Book 2026 – wybór i stosowanie kremu przeciwsłonecznego](https://www.cdc.gov/yellow-book/hcp/environmental-hazards-risks/sun-exposure-in-travelers.html)

### Odzież i okulary przeciwsłoneczne

Lekka odzież osłaniająca skórę może być skuteczniejszą i wygodniejszą ochroną niż wielokrotne smarowanie dużych powierzchni ciała. Przy dłuższym przebywaniu na słońcu można rozważyć lekką odzież turystyczną lub kąpielową oznaczoną UPF 30–50+. Koszulki kąpielowe typu rashguard z UPF 50 są szczególnie praktyczne przy dłuższym pływaniu.

Okulary przeciwsłoneczne powinny zapewniać ochronę przed UVA i UVB. WHO zaleca okulary blokujące 99–100% promieniowania UVA i UVB, najlepiej osłaniające oczy również z boków.

Źródła:

- [WHO – odzież, kapelusz i okulary jako ochrona przed promieniowaniem UV](https://www.who.int/news-room/fact-sheets/detail/ultraviolet-radiation)
- [CDC Yellow Book 2026 – odzież UPF i okulary przeciwsłoneczne w podróży](https://www.cdc.gov/yellow-book/hcp/environmental-hazards-risks/sun-exposure-in-travelers.html)

### Kiedy ograniczać ekspozycję na słońce

CDC i GIS zalecają szczególną ostrożność w godzinach około **10:00–16:00**, kiedy promieniowanie UV jest zwykle najsilniejsze. Zwiedzanie, spacer czy plażowanie lepiej w miarę możliwości planować rano lub później po południu, a w środku dnia częściej korzystać z cienia.

W upale należy również regularnie pić płyny, odpoczywać w chłodniejszym miejscu i zwracać uwagę na objawy przegrzania. Luźna, lekka odzież i szerokie rondo chronią jednocześnie przed UV oraz zmniejszają obciążenie cieplne.

Źródła:

- [GIS – praktyczne zasady bezpiecznego korzystania ze słońca](https://www.gov.pl/web/gis/bezpieczne-lato--jak-chronic-sie-przed-sloncem-i-cieszyc-wakacjami)
- [CDC Yellow Book 2026 – zapobieganie chorobom związanym z upałem](https://www.cdc.gov/yellow-book/hcp/environmental-hazards-risks/heat-and-cold-illness-in-travelers.html)

### Leki i większa wrażliwość na słońce

Niektóre leki mogą zwiększać wrażliwość skóry na promieniowanie słoneczne. GIS zaleca sprawdzanie ulotek stosowanych leków, a CDC wymienia wśród możliwych leków fotouczulających m.in. niektóre antybiotyki i niektóre niesteroidowe leki przeciwzapalne. Osoba przyjmująca stale leki powinna w razie wątpliwości zapytać lekarza lub farmaceutę, czy wymagają one zwiększonej ochrony przed słońcem.

Źródła:

- [GIS – leki mogące zwiększać wrażliwość na słońce](https://www.gov.pl/web/gis/bezpieczne-lato--jak-chronic-sie-przed-sloncem-i-cieszyc-wakacjami)
- [CDC Yellow Book 2026 – leki fotouczulające i ekspozycja na słońce](https://www.cdc.gov/yellow-book/hcp/environmental-hazards-risks/sun-exposure-in-travelers.html)

### Co zrobić przy lekkim oparzeniu słonecznym

Przy łagodnym oparzeniu należy przede wszystkim zejść ze słońca i nie wystawiać oparzonego miejsca na dalszą ekspozycję. NFZ zaleca:

- delikatne schładzanie skóry letnią wodą lub chłodnym, wilgotnym okładem;
- unikanie bardzo zimnej wody i gwałtownego wychładzania;
- odpowiednie nawodnienie;
- stosowanie lekkiej emulsji lub pianki łagodzącej, np. z D-pantenolem lub alantoiną;
- nieprzekłuwanie pęcherzy.

Nie należy przykładać lodu bezpośrednio do skóry. Przy dużych pęcherzach, silnym bólu, gorączce, dreszczach, omdleniu, objawach odwodnienia albo rozległym oparzeniu należy skontaktować się z lekarzem.
...
Biegunka podróżnych nie jest jedną konkretną chorobą ani skutkiem samej zmiany klimatu. To zespół objawów wywoływany przede wszystkim przez zakażenia przewodu pokarmowego. CDC podaje, że najczęstszą przyczyną są bakterie, w tym chorobotwórcze szczepy *Escherichia coli*, *Campylobacter jejuni*, *Shigella* i *Salmonella*; część przypadków powodują wirusy, m.in. norowirus, oraz pasożyty.

CDC określa biegunkę podróżnych jako jedną z najbardziej przewidywalnych chorób związanych z podróżowaniem. Podawany przez CDC zakres 30–70% w czasie dwutygodniowej podróży zależy od kierunku i sezonu i **nie jest statystyką specyficzną dla Dżerby ani konkretnego hotelu**.

Polska Państwowa Inspekcja Sanitarna również opisuje biegunkę podróżnych jako częsty problem i wskazuje na znaczenie higieny żywności oraz jakości wody.

Źródła:

- [CDC Yellow Book 2026 – biegunka podróżnych: przyczyny, profilaktyka i leczenie](https://www.cdc.gov/yellow-book/hcp/preparing-international-travelers/travelers-diarrhea.html)
- [Państwowa Inspekcja Sanitarna – zasady zapobiegania biegunkom podróżnych](https://www.gov.pl/web/psse-siedlce/zasady-zapobiegania-biegunkom-podroznych)

### Co rzeczywiście zmniejsza ryzyko

Nie istnieje metoda dająca stuprocentową ochronę, ponieważ część czynników, np. higiena kuchni restauracyjnej, jest poza kontrolą turysty. Najbardziej uzasadnione są jednak następujące zachowania:

- pić wodę z pewnego źródła; w razie wątpliwości wybierać fabrycznie zamkniętą wodę butelkowaną;
- jeśli bezpieczeństwo wody kranowej jest niepewne, używać bezpiecznej wody również do mycia zębów;
- unikać lodu, jeśli nie ma pewności, że wykonano go z bezpiecznej wody;
- wybierać potrawy świeżo przygotowane i podawane naprawdę gorące;
- unikać surowego lub niedogotowanego mięsa, ryb, owoców morza i jaj;
- ostrożnie podchodzić do surowych sałatek i produktów, których sposobu mycia nie znamy;
- wybierać owoce, które można samodzielnie obrać;
- unikać niepasteryzowanego mleka i produktów z niego;
- myć ręce wodą z mydłem przed jedzeniem i po skorzystaniu z toalety;
- gdy mycie rąk nie jest możliwe, użyć preparatu do dezynfekcji rąk zawierającego co najmniej 60% alkoholu; preparat alkoholowy nie zastępuje mycia rąk w każdej sytuacji.

Źródła:

- [CDC Yellow Book 2026 – bezpieczeństwo żywności i wody podczas podróży](https://www.cdc.gov/yellow-book/hcp/preparing-international-travelers/food-and-water-precautions-for-travelers.html)
- [Państwowa Inspekcja Sanitarna – zasady zapobiegania biegunkom podróżnych](https://www.gov.pl/web/psse-siedlce/zasady-zapobiegania-biegunkom-podroznych)
- [GIS – zdrowie w podróży](https://www.gov.pl/web/gis/zdrowie-w-podrozy)

### Prawdy i mity

#### „Kieliszek alkoholu po posiłku zdezynfekuje żołądek” — mit

Picie alkoholu nie jest zalecaną metodą profilaktyki biegunki podróżnych. CDC w zaleceniach dotyczących bezpieczeństwa żywności i wody nie rekomenduje alkoholu jako środka ochronnego, a wprost podaje, że zawartość alkoholu w napoju **nie zabija patogenów znajdujących się w lodzie zrobionym ze skażonej wody**.

Alkohol ma zastosowanie do dezynfekcji **rąk** w odpowiednim stężeniu: CDC zaleca preparat zawierający co najmniej 60% alkoholu, gdy nie ma możliwości umycia rąk wodą z mydłem. To nie jest odpowiednik „dezynfekowania żołądka” przez picie alkoholu.

Źródło: [CDC Yellow Book 2026 – bezpieczna woda, lód, napoje i higiena rąk](https://www.cdc.gov/yellow-book/hcp/preparing-international-travelers/food-and-water-precautions-for-travelers.html)

#### „Coca-Cola chroni przed zemstą faraona” — mit

Fabrycznie zamknięta puszka lub butelka coli może być bezpieczniejsza mikrobiologicznie od napoju przygotowanego z niepewnej wody, ale **nie dlatego, że cola dezynfekuje przewód pokarmowy**. CDC uznaje fabrycznie zamknięte napoje gazowane za zazwyczaj bezpieczne, a jednocześnie ostrzega przed napojami z dystrybutorów i napojami z lodem, jeśli użyta woda może być niebezpieczna.

Źródło: [CDC Yellow Book 2026 – bezpieczeństwo napojów podczas podróży](https://www.cdc.gov/yellow-book/hcp/preparing-international-travelers/food-and-water-precautions-for-travelers.html)

#### „Cola jest dobrym sposobem leczenia biegunki” — mit

Przy biegunce najważniejsze jest uzupełnianie wody i elektrolitów. Narodowe Centrum Edukacji Żywieniowej NIZP PZH–PIB zaleca doustne płyny nawadniające i wskazuje, że napoje gazowane typu cola mogą nasilać biegunkę. CDC również ostrzega, że duża ilość bardzo słodkich napojów może wywoływać lub nasilać biegunkę osmotyczną.
...
- [CDC Yellow Book 2026 – nawadnianie w biegunce podróżnych](https://www.cdc.gov/yellow-book/hcp/preparing-international-travelers/travelers-diarrhea.html)

#### „Dobry hotel gwarantuje brak biegunki” — mit

Standard hotelu może zmniejszać część zagrożeń, ale nie daje gwarancji. Polska Państwowa Inspekcja Sanitarna zwraca uwagę, że problemy pokarmowe mogą wystąpić również po posiłkach w dobrych hotelach. CDC podkreśla, że niektóre czynniki, np. higiena przygotowania jedzenia w restauracji, pozostają poza kontrolą podróżnego.

Źródła:

- [Państwowa Inspekcja Sanitarna – zasady zapobiegania biegunkom podróżnych](https://www.gov.pl/web/psse-siedlce/zasady-zapobiegania-biegunkom-podroznych)
- [CDC Yellow Book 2026 – biegunka podróżnych](https://www.cdc.gov/yellow-book/hcp/preparing-international-travelers/travelers-diarrhea.html)

### Probiotyki i Enterol

**Enterol 250 mg** jest produktem leczniczym zawierającym 250 mg liofilizowanych drożdżaków *Saccharomyces boulardii* CNCM I-745. Polska ChPL wymienia wśród wskazań **zapobieganie biegunkom podróżnych** oraz podaje dla tego wskazania dawkowanie 1–4 kapsułki na dobę przez okres do jednego tygodnia.

Nie oznacza to jednak, że probiotyk jest pewną ochroną. CDC Yellow Book 2026 ocenia badania nad probiotykami, w tym *Saccharomyces boulardii*, jako niejednoznaczne i stwierdza, że danych jest za mało, aby rekomendować ich rutynowe stosowanie w profilaktyce biegunki podróżnych.

Dlatego **nie przyjmujemy jako grupowej zasady schematu „tydzień przed + pobyt + tydzień po”**. Ewentualne stosowanie Enterolu jest indywidualną decyzją po zapoznaniu się z ChPL i — w razie wątpliwości — konsultacji z lekarzem lub farmaceutą.

Ważne przeciwwskazania z ChPL obejmują m.in. pacjentów z cewnikiem w żyle centralnej oraz osoby w stanie krytycznym lub ze znacznie obniżoną odpornością z powodu ryzyka fungemii. Enterolu nie należy stosować jednocześnie z doustnymi lub dożylnymi lekami przeciwgrzybiczymi. Lek nie zastępuje właściwego nawodnienia.
...
WZW A jest wywoływane przez wirus HAV i dotyczy przede wszystkim wątroby. Okres od zakażenia do pierwszych objawów może wynosić 15–50 dni, średnio około 30 dni. Oznacza to, że osoba może zarazić się podczas wyjazdu i zachorować dopiero po powrocie do Polski.

NIZP PZH–PIB wymienia **Tunezję** wśród krajów o pośredniej lub wysokiej endemiczności WZW A, do których podróżując zalecane jest szczepienie.

Źródło: [NIZP PZH–PIB – wirusowe zapalenie wątroby typu A: choroba, szczepienie i kraje ryzyka](https://szczepienia.pzh.gov.pl/szczepionki/wzw-a/)

### Szczepienie przeciw WZW A przed wyjazdem
...
- [NIZP PZH–PIB – kiedy szczepić przeciw WZW A i jak szybko powstaje odporność](https://szczepienia.pzh.gov.pl/szczepionki/wzw-a/?strona=4)
- [CDC Yellow Book 2026 – wirusowe zapalenie wątroby typu A w podróży](https://www.cdc.gov/yellow-book/hcp/travel-associated-infections-diseases/hepatitis-a.html)
...
- [NIZP PZH–PIB – lista szczepionek przeciw WZW A i ich Charakterystyki Produktów Leczniczych](https://szczepienia.pzh.gov.pl/dla-lekarzy/lista-szczepionek-oraz-chpl-do-pobrania-2/)
- [NIZP PZH–PIB – lista krajów o pośredniej i wysokiej endemiczności WZW A, obejmująca Tunezję](https://szczepienia.pzh.gov.pl/szczepionki/wzw-a/?strona=6)
...
- [Główny Inspektorat Sanitarny – zdrowie w podróży](https://www.gov.pl/web/gis/zdrowie-w-podrozy)
...
- [NIZP PZH–PIB – portal Szczepienia.Info](https://szczepienia.pzh.gov.pl/)
- [Ministerstwo Spraw Zagranicznych, Odyseusz – zdrowie w podróży](https://odyseusz.gov.pl/strona-tematyczna/przed-podroza/zdrowie-w-podrozy)
