...
6. Zwykłe połączenia telefoniczne przez polskiego operatora → tylko po wcześniejszym sprawdzeniu kosztów albo awaryjnie.
7. Wi-Fi Calling → możliwe jako dodatkowa opcja, ale dopiero po sprawdzeniu zasad rozliczania u konkretnego polskiego operatora.
...
- Jaki polski operator i taryfa będą używane podczas wyjazdu.
- Cena pakietu roamingowego dla Tunezji u tego operatora.
- Cena zwykłych połączeń przychodzących i wychodzących w Tunezji.
- Zasady rozliczania Wi-Fi Calling za granicą u tego operatora.
