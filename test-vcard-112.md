...
Wszystkie trzy pliki zawierają ten sam numer telefonu `112` i tę samą wartość pola `FN`: `Polski numer alarmowy`. Nie zawierają pola `N`, czyli imienia ani nazwiska. Różnią się wyłącznie polem `ORG`.
