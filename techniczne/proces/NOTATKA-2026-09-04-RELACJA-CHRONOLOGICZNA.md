# Relacja chronologiczna – 4 września 2026
...
Podczas przygotowań wydarzył się drobny wypadek. Sięgając po wodę z lodówki, zahaczyłem o stojącą tam butelkę wódki należącą do Pawła. Butelka spadła, rozbiła się i wódka się rozlała, a na podłodze zostało sporo potłuczonego szkła. Sprzątanie i uporządkowanie sytuacji zabrało część zapasu czasu, który mieliśmy przed śniadaniem.

Całe zdarzenie miało miejsce jeszcze w pokoju, przed wyjściem na śniadanie i przed zbiórką na wyjazd.

## 05:30 – szybkie śniadanie przed wyjazdem

Na śniadanie zeszliśmy punktualnie około **05:30**. Mimo wcześniejszej informacji od rezydentki, że restauracja będzie już wtedy dostępna dla naszej grupy, w chwili naszego przyjścia była jeszcze zamknięta. Dosłownie po chwili obsługa otworzyła ją, wpuściła nas do środka i zapaliła światła.

Tak wcześnie wybór jedzenia był jednak bardzo ograniczony. Do zjedzenia dostępne były praktycznie tylko słodkie rogaliki typu croissant. Zjedliśmy po kilka na miejscu, a część osób wzięła również po jednym lub kilka na drogę. Do picia można było wziąć sok, a prawdopodobnie także trochę kawy.
...
Sympatycznym detalem był również sprzedawca, który znał kilka słów po polsku. Gdy Mikołaj próbował rozmawiać z nim po francusku lub angielsku i pytał o napój, sprzedawca odpowiadał po polsku: **„herbata, herbata”**. Mikołaj odebrał to jako kolejny, podobny do wcześniejszych miejsc, przykład tego, że osoby pracujące przy turystyce znają pojedyncze polskie słowa. Jego zdaniem najpewniej wynika to z częstych wizyt polskich turystów w tych miejscach; zapisujemy to jako obserwację i interpretację uczestnika, a nie zweryfikowany fakt statystyczny.
